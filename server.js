...
/*
  Alice = URA / voz institucional
  Nova e Victoria = representantes com voz mais humana/neural

  Se Polly.Joanna-Neural ou Polly.Amy-Neural der erro na Twilio,
  troque para:
  - Polly.Joanna
  - Polly.Amy
  - woman
...
/* ============================================================
   MAIN MENU — ALICE FIRST, THEN REPRESENTATIVE
   ============================================================ */
...
function buildMainMenu(lineKey = "MAIN_SUPPORT") {
  ...
  if (lineKey === "BUSINESS") {
    r.say(
      repVoice,
      "Hi, this is Victoria with Lukintosh Business. Thank you for waiting."
    );
    ...
    r.say(
      repVoice,
      "Hi, this is Nova with Lukintosh Support. Thank you for waiting."
    );

    r.say(
      repVoice,
      "I can help route your request, collect support details, and create a support record."
    );
  }

  // Primeiro tenta fala natural
  const speechGather = r.gather({
    input: "speech",
    timeout: 5,
    speechTimeout: "auto",
    action: `${BASE_URL}/spoken-request?line=${lineKey}`,
    method: "POST",
    language: "en-US",
  });
  ...
  if (lineKey === "BUSINESS") {
    speechGather.say(
      repVoice,
      "Please tell me briefly what your business inquiry is about. For example, partnership, media, developer relations, legal, or corporate information."
    );
  } else {
    speechGather.say(
      repVoice,
      "Please tell me briefly what you need help with. For example, account access, Yeux setup, billing, technical errors, or security."
    );
  }

  // Se a pessoa não falar nada, cai para menu por botão
  r.say(
    repVoice,
    "I did not hear anything clearly. I will continue with the phone menu."
  );
...
/* ============================================================
   SPOKEN REQUEST — USER TALKS ON THE PHONE
   ============================================================ */

app.post("/spoken-request", (req, res) => {
  const r = twiml();
  ...
  console.log("Spoken request received:", {
    line: line.label,
  ...
  if (speech) {
    r.say(repVoice, "Thank you. I captured your request.");

    r.say(
      repVoice,
      "I will include your spoken description in the support record."
    );

    r.say(
      repVoice,
      "Please hold for a moment while I route your request."
    );
    ...
    if (lineKey === "BUSINESS") {
      r.say(
        repVoice,
        "I will now create a business inquiry record. Please leave any additional details after the tone. Include your name, organization, email address, and phone number."
      );
    } else {
      r.say(
        repVoice,
        "I will now create a support record. Please leave any additional details after the tone. Include your name, email address, and phone number."
      );
    }
  } else {
    r.say(
    ...
    r.say(
      repVoice,
      "Please leave your name, email address, phone number, and a short description after the tone."
    );
  }
  ...
  r.record({
    ...
    playBeep: true,
    transcribe: false,
    action: `${BASE_URL}/voicemail?line=${lineKey}&department=spoken&ticket=000000&reason=spoken-request`,
    method: "POST",
  });
...
function buildPreview(lineKey = "MAIN_SUPPORT") {
  ...
  if (lineKey === "BUSINESS") {
    ...
    r.say(
      repVoice,
      "Please tell me briefly what your business inquiry is about."
    );
  } else {
    r.say(
      repVoice,
  ...
  r.say(repVoice, "Thank you. I captured your request.");
  r.say(repVoice, "Please leave any additional details after the tone.");
...
/* ============================================================
   LANGUAGE MENU — FALLBACK BY BUTTON
   ============================================================ */
...
app.post("/language", (req, res) => {
  ...
  r.say(repVoice, `You are now in the ${line.publicName} menu.`);
  ...
  if (lineKey === "BUSINESS") {
    ...
    gather.say(systemVoice, "For Yeux accessibility and eye tracking support, press 2.");
    gather.say(systemVoice, "For developer tools, APIs, and platform services, press 3.");
    gather.say(systemVoice, "For security and account protection, press 4.");
    gather.say(systemVoice, "For company, media, and business information, press 5.");
  }
...
/* ============================================================
   DEPARTMENT MENU — FALLBACK BY BUTTON
   ============================================================ */
...
/* ============================================================
   ACCOUNT / TICKET CODE — FALLBACK BY BUTTON
   ============================================================ */
...
/* ============================================================
   REASON / HOLD / RECORD — FALLBACK BY BUTTON
   ============================================================ */
...
app.post("/voicemail", (req, res) => {
  ...
  r.say(repVoice, "A Lukintosh support record has been created for this call.");
